...
**Source URL:** https://orm.drizzle.team/docs/drizzle-kit-push
...
[ Overview ](/docs/kit-overview)[ `generate` ](/docs/drizzle-kit-generate)[ `migrate` ](/docs/drizzle-kit-migrate)[ `push` ](/docs/drizzle-kit-push)

Schema files path  Multiple configuration files in one project  Specifying database driver  Including tables, schemas and extensions  Extended list of configurations  Extended example 
