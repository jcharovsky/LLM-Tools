...
**Source URL:** https://orm.drizzle.team/docs/arktype
...
[ Prisma ](/docs/prisma)[ ESLint Plugin ](/docs/eslint-plugin)[ drizzle-zod ](/docs/zod)[ drizzle-typebox ](/docs/typebox)[ drizzle-valibot ](/docs/valibot)[ drizzle-arktype ](/docs/arktype)

Install the dependencies  Select schema  Insert schema  Update schema  Refinements  Data type reference 

[ drizzle-graphql ](/docs/graphql)
