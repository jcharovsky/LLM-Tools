...
**Source URL:** https://orm.drizzle.team/docs/cache
...
[ Set Operations ](/docs/set-operations)[ Generated Columns ](/docs/generated-columns)[ Transactions ](/docs/transactions)[ Batch ](/docs/batch-api)[ Cache ](/docs/cache)

Quickstart  Upstash integration  Cache config reference  Cache usage examples  Custom cache  Limitations 

[ Dynamic query building ](/docs/dynamic-query-building)[ Read Replicas ](/docs/read-replicas)[ Custom types ](/docs/custom-types)[ Goodies ](/docs/goodies)
...
In this case, the following query won’t read from cache
    ...
    await db.insert(users).value({ email: "[[email protected]](/cdn-cgi/l/email-protection)" });
