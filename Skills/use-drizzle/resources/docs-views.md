...
**Source URL:** https://orm.drizzle.team/docs/views
...
Data types [ Indexes & Constraints ](/docs/indexes-constraints)[ Sequences ](/docs/sequences)[ Views ](/docs/views)

Declaring views  Declaring views with raw SQL  Declaring existing views  Materialized views  Extended example 

[ Schemas ](/docs/schemas)[ Row-Level Security (RLS) ](/docs/rls) Extensions [ Relations ](/docs/relations)
