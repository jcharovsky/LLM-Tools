...
**Source URL:** https://orm.drizzle.team/docs/update
...
[ Query ](/docs/rqb)[ Select ](/docs/select)[ Insert ](/docs/insert)[ Update ](/docs/update)

Limit  Order By  Update with returning  with update clause  Update … from 

[ Delete ](/docs/delete)[ Filters ](/docs/operators)[ Utils ](/docs/query-utils)[ Joins ](/docs/joins)[ Magic sql`` operator ](/docs/sql)
