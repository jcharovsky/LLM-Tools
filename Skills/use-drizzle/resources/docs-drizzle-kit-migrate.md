...
**Source URL:** https://orm.drizzle.team/docs/drizzle-kit-migrate
...
[ Overview ](/docs/kit-overview)[ `generate` ](/docs/drizzle-kit-generate)[ `migrate` ](/docs/drizzle-kit-migrate)

Applied migrations log in the database  Multiple configuration files in one project  Extended example 
