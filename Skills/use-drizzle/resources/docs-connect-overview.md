...
**Source URL:** https://orm.drizzle.team/docs/connect-overview
...
[ Schema ](/docs/sql-schema-declaration)[ Database connection ](/docs/connect-overview)

[ Query data ](/docs/data-querying)[ Migrations ](/docs/migrations)
...
Just in case if you’re not familiar with database connection URL concept
    ...
    postgresql://alex:[[email protected]](/cdn-cgi/l/email-protection)/dbname
                 └──┘ └───────┘ └─────────────────────────────────────────────┘ └────┘
                  ʌ    ʌ          ʌ                                              ʌ
