...
**Source URL:** https://orm.drizzle.team/docs/connect-drizzle-proxy
...
SQLite
    ...
    const main = async () => {
        const connection = await mysql.createConnection('mysql://root:[[email protected]](/cdn-cgi/l/email-protection):5432/drizzle');
