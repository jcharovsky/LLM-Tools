...
**Source URL:** https://orm.drizzle.team/docs/goodies
...
Type API  Logging  Multi-project schema  Printing SQL query  Raw SQL queries execution  Standalone query builder  Get typed table columns  Get table information  Compare objects types (instanceof alternative)  Mock Driver 
