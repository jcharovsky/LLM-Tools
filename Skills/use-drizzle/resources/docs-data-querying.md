...
**Source URL:** https://orm.drizzle.team/docs/data-querying
...
[ Schema ](/docs/sql-schema-declaration)[ Database connection ](/docs/connect-overview)[ Query data ](/docs/data-querying)

Why SQL-like?  Why not SQL-like?  Advanced 
...
delete
    ...
    await db.insert(users).values({ email: '[[email protected]](/cdn-cgi/l/email-protection)' })
    
    
    INSERT INTO users (email) VALUES ('[[email protected]](/cdn-cgi/l/email-protection)')
