...
**Source:** https://tanstack.com/router/latest/docs/contributors
...
Menu
  ...
  * [Home](/router/latest)
  * [Frameworks](/router/latest/docs/framework)
...
Getting Started
  ...
  * [Overviewreact](/router/latest/docs/framework/react/overview)
  * [Quick Startreact](/router/latest/docs/framework/react/quick-start)
  * [Devtoolsreact](/router/latest/docs/framework/react/devtools)
  * [Decisions on DXreact](/router/latest/docs/framework/react/decisions-on-dx)
  * [LLM Assistance Supportreact](/router/latest/docs/framework/react/llm-support)
  * [Comparisonreact](/router/latest/docs/framework/react/comparison)
  * [Frequently Asked Questionsreact](/router/latest/docs/framework/react/faq)



Installation Guides

  * [Manual Setupreact](/router/latest/docs/framework/react/installation/manual)
  * [Vitereact](/router/latest/docs/framework/react/installation/with-vite)
  * [Rspack/Rsbuildreact](/router/latest/docs/framework/react/installation/with-rspack)
  * [Webpackreact](/router/latest/docs/framework/react/installation/with-webpack)
  * [Esbuildreact](/router/latest/docs/framework/react/installation/with-esbuild)
  * [Router CLIreact](/router/latest/docs/framework/react/installation/with-router-cli)
  * [Migrate from React Routerreact](/router/latest/docs/framework/react/installation/migrate-from-react-router)
  * [Migrate from React Locationreact](/router/latest/docs/framework/react/installation/migrate-from-react-location)



Routing

  * [Routing Conceptsreact](/router/latest/docs/framework/react/routing/routing-concepts)
  * [Route Treesreact](/router/latest/docs/framework/react/routing/route-trees)
  * [Route Matchingreact](/router/latest/docs/framework/react/routing/route-matching)
  * [File-Based Routingreact](/router/latest/docs/framework/react/routing/file-based-routing)
  * [Virtual File Routesreact](/router/latest/docs/framework/react/routing/virtual-file-routes)
  * [Code-Based Routingreact](/router/latest/docs/framework/react/routing/code-based-routing)
  * [File Naming Conventionsreact](/router/latest/docs/framework/react/routing/file-naming-conventions)



Guides

  * [Code Splittingreact](/router/latest/docs/framework/react/guide/code-splitting)
  * [Automatic Code Splittingreact](/router/latest/docs/framework/react/guide/automatic-code-splitting)
  * [Creating a Routerreact](/router/latest/docs/framework/react/guide/creating-a-router)
  * [Outletsreact](/router/latest/docs/framework/react/guide/outlets)
  * [Navigationreact](/router/latest/docs/framework/react/guide/navigation)
  * [Path Paramsreact](/router/latest/docs/framework/react/guide/path-params)
  * [Search Paramsreact](/router/latest/docs/framework/react/guide/search-params)
  * [Link Optionsreact](/router/latest/docs/framework/react/guide/link-options)
  * [Custom Linksreact](/router/latest/docs/framework/react/guide/custom-link)
  * [Data Loadingreact](/router/latest/docs/framework/react/guide/data-loading)
  * [Deferred Data Loadingreact](/router/latest/docs/framework/react/guide/deferred-data-loading)
  * [External Data Loadingreact](/router/latest/docs/framework/react/guide/external-data-loading)
  * [Data Mutationsreact](/router/latest/docs/framework/react/guide/data-mutations)
  * [Type Safetyreact](/router/latest/docs/framework/react/guide/type-safety)
  * [Type Utilitiesreact](/router/latest/docs/framework/react/guide/type-utilities)
  * [Preloadingreact](/router/latest/docs/framework/react/guide/preloading)
  * [Document Head Managementreact](/router/latest/docs/framework/react/guide/document-head-management)
  * [Route Maskingreact](/router/latest/docs/framework/react/guide/route-masking)
  * [Navigation Blockingreact](/router/latest/docs/framework/react/guide/navigation-blocking)
  * [Custom Search Param Serializationreact](/router/latest/docs/framework/react/guide/custom-search-param-serialization)
  * [History Typesreact](/router/latest/docs/framework/react/guide/history-types)
  * [Router Contextreact](/router/latest/docs/framework/react/guide/router-context)
  * [Not Found Errorsreact](/router/latest/docs/framework/react/guide/not-found-errors)
  * [Authenticated Routesreact](/router/latest/docs/framework/react/guide/authenticated-routes)
  * [Scroll Restorationreact](/router/latest/docs/framework/react/guide/scroll-restoration)
  * [Static Route Datareact](/router/latest/docs/framework/react/guide/static-route-data)
  * [SSRreact](/router/latest/docs/framework/react/guide/ssr)
  * [Render Optimizationsreact](/router/latest/docs/framework/react/guide/render-optimizations)



API

  * [File-Based Routingcore](/router/latest/docs/api/file-based-routing)
  * [Routerreact](/router/latest/docs/framework/react/api/router)



Integrations

  * [TanStack Queryreact](/router/latest/docs/integrations/query)



ESLint

  * [ESLint Plugin Routercore](/router/latest/docs/eslint/eslint-plugin-router)
  * [Create Route Property Ordercore](/router/latest/docs/eslint/create-route-property-order)



Router Examples

  * [Quickstart (file-based)react](/router/latest/docs/framework/react/examples/quickstart-file-based)
  * [Quickstart (code-based)react](/router/latest/docs/framework/react/examples/quickstart)
  * [Basic (file-based)react](/router/latest/docs/framework/react/examples/basic-file-based)
  * [Basic (code-based)react](/router/latest/docs/framework/react/examples/basic)
  * [Basic + React Query (file-based)react](/router/latest/docs/framework/react/examples/basic-react-query-file-based)
  * [Basic + React Query (code-based)react](/router/latest/docs/framework/react/examples/basic-react-query)
  * [Basic + SSR (file-based)react](/router/latest/docs/framework/react/examples/basic-ssr-file-based)
  * [Basic + SSR Streaming (file-based)react](/router/latest/docs/framework/react/examples/basic-ssr-streaming-file-based)
  * [Kitchen Sink (file-based)react](/router/latest/docs/framework/react/examples/kitchen-sink-file-based)
  * [Kitchen Sink (code-based)react](/router/latest/docs/framework/react/examples/kitchen-sink)
  * [Kitchen Sink + React Query (file-based)react](/router/latest/docs/framework/react/examples/kitchen-sink-react-query-file-based)
  * [Kitchen Sink + React Query (code-based)react](/router/latest/docs/framework/react/examples/kitchen-sink-react-query)
  * [Location Maskingreact](/router/latest/docs/framework/react/examples/location-masking)
  * [Authenticated Routesreact](/router/latest/docs/framework/react/examples/authenticated-routes)
  * [Scroll Restorationreact](/router/latest/docs/framework/react/examples/scroll-restoration)
  * [Deferred Datareact](/router/latest/docs/framework/react/examples/deferred-data)
  * [Navigation Blockingreact](/router/latest/docs/framework/react/examples/navigation-blocking)
  * [View Transitionsreact](/router/latest/docs/framework/react/examples/view-transitions)
  * [With tRPCreact](/router/latest/docs/framework/react/examples/with-trpc)
  * [With tRPC + React Queryreact](/router/latest/docs/framework/react/examples/with-trpc-react-query)
  * [Monorepo basicreact](/router/latest/docs/framework/react/examples/router-monorepo-simple)
  * [Monorepo basic (with lazy loading)react](/router/latest/docs/framework/react/examples/router-monorepo-simple-lazy)
  * [Monorepo with React Queryreact](/router/latest/docs/framework/react/examples/router-monorepo-react-query)
...
[![Avatar of Brooke Holmes](https://github.com/brhx.png)ReactTypeScript](https://github.com/brhx)
...
**Source:** https://tanstack.com/router/latest/docs/framework/react/examples/kitchen-sink-file-based
...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/tanstack/router/tree/main/examples/react/kitchen-sink-file-based)[![Deploy with Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com
%2013%206.7%2030.4%205.8%2039-2%203.7-3.4%205.3-7%205.3-12%200-4.6-.7-6.7-3-10.2-3.2-4.4-9.6-8-27.6-16-20.7-8.8-29.5-14.4-37.7-23-4.7-5.2-9-13.3-11-20-1.5-5.8-2-20-.6-25.7%204.3-20%2019.4-34%2041-38%207-1.4%2023.5-.8%2030.4%201l-.2.2z'/%3e%3c/svg%3e)InvoiceFields.tsx

      * ![Spinner.tsx file icon](data:image/svg+xml,%3csvg%20id='Layer_1'%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20400%20400'%20width='2500'%20height='2500'%3e%3cstyle%3e.st0{fill:%23007acc}.st1{fill:%23fff}%3c/style%3e%3cpath%20class='st0'%20d='M0%20200V0h400v400H0'/%3e%3cpath%20class='st1'%20d='M87.7%20200.7V217h52v148h36.9V217h52v-16c0-9%200-16.3-.4-16.5%200-.3-31.7-.4-70.2-.4l-70%20.3v16.4l-.3-.1zM321.4%20184c10.2%202.4%2018%207%2025%2014.3%203.7%204%209.2%2011%209.6%2012.8%200%20.6-17.3%2012.3-27.8%2018.8-.4.3-2-1.4-3.6-4-5.2-7.4-10.5-10.6-18.8-11.2-12-.8-20%205.5-20%2016%200%203.2.6%205%201.8%207.6%202.7%205.5%207.7%208.8%2023.2%2015.6%2028.6%2012.3%2041%2020.4%2048.5%2032%208.5%2013%2010.4%2033.4%204.7%2048.7-6.4%2016.7-22%2028-44.3%2031.7-7%201.2-23%201-30.5-.3-16-3-31.3-11-40.7-21.3-3.7-4-10.8-14.7-10.4-15.4l3.8-2.4%2015-8.7%2011.3-6.6%202.6%203.5c3.3%205.2%2010.7%2012.2%2015%2014.6%2013%206.7%2030.4%205.8%2039-2%203.7-3.4%205.3-7%205.3-12%200-4.6-.7-6.7-3-10.2-3.2-4.4-9.6-8-27.6-16-20.7-8.8-29.5-14.4-37.7-23-4.7-5.2-9-13.3-11-20-1.5-5.8-2-20-.6-25.7%204.3-20%2019.4-34%2041-38%207-1.4%2023.5-.8%2030.4%201l-.2.2z'/%3e%3c/svg%3e)Spinner.tsx
...
[Basic + SSR Streaming (file-based)](/router/latest/docs/framework/react/examples/basic-ssr-streaming-file-based)

[Kitchen Sink (code-based) ](/router/latest/docs/framework/react/examples/kitchen-sink)
...
On this page
  ...
  * ["A Fork in the Route"](/router/latest/docs/framework/react/overview#a-fork-in-the-route)
  * [Why TanStack Router?](/router/latest/docs/framework/react/overview#why-tanstack-router)
  * [100% Inferred TypeScript Support](/router/latest/docs/framework/react/overview#100-inferred-typescript-support)
  * [1st Class Search Parameters](/router/latest/docs/framework/react/overview#1st-class-search-parameters)
  * [Built-In Caching and Friendly Data Loading](/router/latest/docs/framework/react/overview#built-in-caching-and-friendly-data-loading)
  * [Built-in Cache](/router/latest/docs/framework/react/overview#built-in-cache)
  * [Flexible & Powerful Data Lifecycle APIs](/router/latest/docs/framework/react/overview#flexible--powerful-data-lifecycle-apis)
  * [Inherited Route Context](/router/latest/docs/framework/react/overview#inherited-route-context)
  * [File-based and/or Code-Based Routing](/router/latest/docs/framework/react/overview#file-based-andor-code-based-routing)
  * [Acknowledgements](/router/latest/docs/framework/react/overview#acknowledgements)
  * [Let's go!](/router/latest/docs/framework/react/overview#lets-go)
