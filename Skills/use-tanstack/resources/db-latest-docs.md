...
Getting Started
  ...
  * [React Adapterreact](/db/latest/docs/framework/react/adapter)
...
Guides
  ...
  * [Mutationscore](/db/latest/docs/guides/mutations)
  * [Error Handlingcore](/db/latest/docs/guides/error-handling)
  * [Creating Collection Options Creatorscore](/db/latest/docs/guides/collection-options-creator)
...
Collections
  ...
  * [Electric Collectioncore](/db/latest/docs/collections/electric-collection)
  * [RxDB Collectioncore](/db/latest/docs/collections/rxdb-collection)



Community

  * [Resources & Packagescore](/db/latest/docs/community/resources)
...
API Reference
  ...
  * [RxDB DB Collectioncore](/db/latest/docs/reference/rxdb-db-collection/index)
  * [rxdbCollectionOptionscore](/db/latest/docs/reference/rxdb-db-collection/functions/rxdbcollectionoptions)
...
On this page
  ...
  * [TanStack DB - Documentation](/db/latest/docs/overview#tanstack-db---documentation)
  * [Contents](/db/latest/docs/overview#contents)
  * [How it works](/db/latest/docs/overview#how-it-works)
  * [Defining collections](/db/latest/docs/overview#defining-collections)
  * [Using live queries](/db/latest/docs/overview#using-live-queries)
  * [Making optimistic mutations](/db/latest/docs/overview#making-optimistic-mutations)
  * [Uni-directional data flow](/db/latest/docs/overview#uni-directional-data-flow)
  * [API reference](/db/latest/docs/overview#api-reference)
  * [Collections](/db/latest/docs/overview#collections)
  * [Collection schemas](/db/latest/docs/overview#collection-schemas)
  * [`QueryCollection`](/db/latest/docs/overview#querycollection)
  * [`ElectricCollection`](/db/latest/docs/overview#electriccollection)
  * [`TrailBaseCollection`](/db/latest/docs/overview#trailbasecollection)
  * [`RxDBCollection`](/db/latest/docs/overview#rxdbcollection)
  * [`LocalStorageCollection`](/db/latest/docs/overview#localstoragecollection)
  * [`LocalOnlyCollection`](/db/latest/docs/overview#localonlycollection)
  * [Derived collections](/db/latest/docs/overview#derived-collections)
  * [Collection](/db/latest/docs/overview#collection)
  * [Live queries](/db/latest/docs/overview#live-queries)
  * [`useLiveQuery` hook](/db/latest/docs/overview#uselivequery-hook)
  * [`queryBuilder`](/db/latest/docs/overview#querybuilder)
  * [Transactional mutators](/db/latest/docs/overview#transactional-mutators)
  * [Usage examples](/db/latest/docs/overview#usage-examples)
  * [1\. TanStack Query](/db/latest/docs/overview#1-tanstack-query)
  * [2\. ElectricSQL sync](/db/latest/docs/overview#2-electricsql-sync)
  * [React Native](/db/latest/docs/overview#react-native)
  * [More info](/db/latest/docs/overview#more-info)
...
Contents
  ...
  * How it works â€” understand the TanStack DB development model and how the pieces fit together
  * API reference â€” for the primitives and function interfaces
  * Usage examples â€” examples of common usage patterns
  * More info â€” where to find support and more information
...
For more complex mutations, you can create custom actions with createOptimisticAction or custom transactions with createTransaction. See the [Mutations guide](/db/latest/docs/guides/mutations) for details.
...
[ ![](https://raw.githubusercontent.com/TanStack/db/main/docs/unidirectional-data-flow.png) ](https://raw.githubusercontent.com/TanStack/db/main/docs/unidirectional-data-flow.lg.png)
...
There are a number of built-in collection types:
  ...
  1. QueryCollection to load data into collections using [TanStack Query](https://tanstack.com/query)
  2. ElectricCollection to sync data into collections using [ElectricSQL](https://electric-sql.com)
  3. TrailBaseCollection to sync data into collections using [TrailBase](https://trailbase.io)
  4. RxDBCollection to integrate with [RxDB](https://rxdb.info) for local persistence and sync
...
See the [Mutations guide](/db/latest/docs/guides/mutations) for comprehensive documentation on:
...
[Quick Start ](/db/latest/docs/quick-start)
...
**Source:** https://tanstack.com/db/latest/docs/contributors
...
# TanStack DB Maintainers and Contributors

[![Avatar of Kyle Mathews](https://github.com/KyleAMathews.png)ReactSync Engines](https://github.com/KyleAMathews)
...
[![Avatar of Sam Willis](https://github.com/samwillis.png)ReactSync EnginesIncremental View Maintenance](https://github.com/samwillis)
...
[![Avatar of Kevin De Porre](https://github.com/kevin-dp.png)ReactSync EnginesIncremental View Maintenance](https://github.com/kevin-dp)

Kevin De Porre

Maintainer

[](https://github.com/kevin-dp)
...
[![GitHub Contributors](https://contrib.rocks/image?repo=tanstack/db)](https://github.com/tanstack/db/graphs/contributors)

Powered by [contrib.rocks](https://contrib.rocks)

[View all contributors on GitHub](https://github.com/tanstack/db/graphs/contributors)
