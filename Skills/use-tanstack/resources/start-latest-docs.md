...
[Tailwind CSS Integration](/start/latest/docs/framework/react/guide/tailwind-integration)

[Basic + React Query ](/start/latest/docs/framework/react/examples/start-basic-react-query)
...
On this page
  ...
  * [Dependencies](/start/latest/docs/framework/react/overview#dependencies)
  * [Should I use TanStack Start or just TanStack Router?](/start/latest/docs/framework/react/overview#should-i-use-tanstack-start-or-just-tanstack-router)
  * [Are there limitations?](/start/latest/docs/framework/react/overview#are-there-limitations)
  * [How is TanStack Start funded?](/start/latest/docs/framework/react/overview#how-is-tanstack-start-funded)
  * [Ready to get started?](/start/latest/docs/framework/react/overview#ready-to-get-started)
